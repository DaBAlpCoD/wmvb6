...
'Print
'Print "                                                           i . tta"
'Print "z = x + i . y = rh . [cos(tta) + i . sin(tta)] = rh . e"
'Print
'Print "                                       0.5        "
'Print "On a :  module de z   = |z| = (xý + yý)    = rh  "
'Print
'Print "        argument de z = Arg(z) = tta"
'Print
'Print
'Do
   ' *****************************************************
...
'   Print
'   Print " 0) arrter"
'   Print " 1) passer de (x,y)  (rh, tta)"
'  Print " 2) passer de (rh, tta)  (x,y)"
...
'   Case 1
'      ' *****************************************************
'      ' passer de (x,y)  (rh, tta)"
'      ' *****************************************************
'      LOCATE 14, 1
'      INPUT "x = ", x
'      INPUT "y = ", y
'      ' *****************************************************
      ' calcul de rh et tta  partir de x et y
      ' *****************************************************
'      rho = Sqr(X * X + Y * Y)
'      If Abs(Y) < eps Then
'         If Abs(X) < eps Then
...
'      INPUT "tta = ", teta
      ' *****************************************************
      ' calcul de x et y  partir de rh et tta
      ' *****************************************************
'      X = rho * Cos(TETA)
'      Y = rho * Sin(TETA)
      ' *****************************************************
